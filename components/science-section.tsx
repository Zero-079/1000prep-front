...
const stats = [
  { icon: Flame, value: "500+", label: "Recetas disponibles" },
  { icon: Clock, value: "15", label: "Minutos para calentar" },
  { icon: Truck, value: "100%", label: "Entrega puntual" },
  { icon: Award, value: "10K+", label: "Clientes satisfechos" },
]
...
const principles = [
  {
    ...
    description:
      "Seleccionamos cuidadosamente cada ingrediente de proveedores locales, garantizando frescura y calidad en cada comida.",
  },
  {
    number: "02",
    title: "Macros calculados",
    description: "Cada comida viene con informacion nutricional exacta: proteinas, carbohidratos y grasas medidos con precision.",
  },
  {
    number: "03",
    title: "Planes personalizados",
    description: "Adaptamos tu menu segun tus objetivos: perdida de peso, ganancia muscular o mantenimiento saludable.",
  },
]
...
export function ScienceSection() {
  ...
  return (
    <section ref={sectionRef} id="suplementos" className="py-24 lg:py-32 bg-primary text-primary-foreground">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16 lg:mb-20">
          ...
          <ScrollBlurText
            text="Nutricion que transforma"
            className="font-serif text-3xl md:text-4xl text-primary-foreground text-balance mb-6 lg:text-7xl font-semibold"
          />
          <p className="reveal opacity-0 animation-delay-400 text-lg text-primary-foreground/80 max-w-2xl mx-auto leading-relaxed">
            Combinamos ciencia nutricional, ingredientes frescos y conveniencia para que alcances tus objetivos sin complicaciones.
          </p>
        </div>
